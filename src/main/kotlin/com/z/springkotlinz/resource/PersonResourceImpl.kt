...
@RestController
@RequestMapping(value=[PersonResourceImpl.BASE_PERSON_URL])
class PersonResourceImpl(
    ...
    override fun findAll(): ResponseEntity<List<PersonResponse>> =
            ResponseEntity.ok(this.personManagementService.findAll())
    ...
    override fun save(
        ...
        return ResponseEntity.created(
                URI.create(BASE_PERSON_URL.plus("/${personResponse.id}")))
                .body(personResponse)
    }
